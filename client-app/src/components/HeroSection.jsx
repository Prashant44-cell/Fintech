...
export default function HeroSection() {
  ...
  // Video playback & progress updates
  const togglePlay = () => {
    if (videoRef.current) {
      if (isPlaying) {
  ...
  // Slides data for horizontal interactive feature carousel
  const slides = [
    {
      id: 0,
  ...
  return (
    <div className="hero-section-container">
      ...
      <div className="hero-perspective-wrapper">
        ...
        >
          {/* Specular Dynamic Light Reflection Overlay */}
          ...
          <div style={{
            ...
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(6, 182, 212, 0.15)', border: '1px solid rgba(6, 182, 212, 0.4)', padding: '0.35rem 0.85rem', borderRadius: '30px', marginBottom: '0.75rem' }}>
                <Sparkles size={14} color="#06b6d4" />
                <span style={{ fontSize: '0.75rem', fontWeight: '800', color: '#38bdf8', letterSpacing: '0.05em' }}>
                  FEATURED HERO SHOWCASE
                </span>
              </div>
              <h2 style={{ fontSize: '1.75rem', fontWeight: '900', letterSpacing: '-0.02em', background: 'linear-gradient(135deg, #ffffff 0%, #94a3b8 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginTop: '0.25rem', maxWidth: '650px' }}>
                Hover over the hero container to experience 3D mouse tracking tilt and explore our real-time liveness verification.
              </p>
            </div>
          ...
          {/* Main Hero Video Frame Container */}
          <div className="video-frame-container">
            {/* Top Overlay Badges */}
            <div className="video-badge-top-left">
              <ShieldCheck size={16} color="#38bdf8" />
              <span>STITCH ID • 4K SHOWCASE</span>
            </div>
          ...
          {/* Infinite Sliding Marquee Animation Banner */}
          <div className="hero-marquee-wrapper" style={{ transform: 'translateZ(25px)' }}>
            <div className="hero-marquee-track">
              ...
              <span className="hero-marquee-item"><CheckCircle2 size={16} color="#06b6d4" /> SEPOLIA SMART CONTRACT PROOFS</span>
              <span className="hero-marquee-item"><CheckCircle2 size={16} color="#8b5cf6" /> CONTINUOUS TRUST SCORING</span>
              ...
              {/* Duplicate track for seamless infinite sliding */}
              <span className="hero-marquee-item"><CheckCircle2 size={16} color="#10b981" /> REAL-TIME IRIS LIVENESS</span>
              <span className="hero-marquee-item"><CheckCircle2 size={16} color="#06b6d4" /> SEPOLIA SMART CONTRACT PROOFS</span>
              <span className="hero-marquee-item"><CheckCircle2 size={16} color="#8b5cf6" /> CONTINUOUS TRUST SCORING</span>
              <span className="hero-marquee-item"><CheckCircle2 size={16} color="#f59e0b" /> ZERO RAW BIOMETRIC STORAGE</span>
          ...
          {/* Interactive Feature Slider / Carousel Cards */}
              ...
              return (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                    ...
                    <span style={{ fontSize: '0.65rem', fontWeight: '800', color: isActive ? '#06b6d4' : '#64748b' }}>
                      {slide.tag}
                    </span>
                  </div>
